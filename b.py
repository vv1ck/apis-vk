...
bot = TeleBot('5730261634:AAHoY2V5dqYAvhHWjLL_OusRMbuWsXPrVps',threaded=True)#enter token Bot ..
...
def Jok1(message):
	...
	else:bot.send_message(message.chat.id,massegeSENT.CLBOT(),reply_markup=BOTN)
